...
sleep 1
tmux send-keys -t $NAME:0.1 'curl "localhost:11127/?op=meetup&val=alice"' C-m
tmux send-keys -t $NAME:0.2 'curl "localhost:11127/?op=meetup&val=carol"' C-m
tmux send-keys -t $NAME:0.3 'curl "localhost:11127/?op=meetup&val=bob"' C-m
tmux send-keys -t $NAME:0.4 'curl "localhost:11127/?op=meetup&val=ted"' C-m
