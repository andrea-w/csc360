...
sleep 1
tmux send-keys -t $NAME:0.1 'curl "localhost:11127/?op=write&val=june2018"' C-m
tmux send-keys -t $NAME:0.2 'curl "localhost:11127/?op=read"' C-m
tmux send-keys -t $NAME:0.3 'curl "localhost:11127/?op=read"' C-m
tmux send-keys -t $NAME:0.4 'curl "localhost:11127/?op=read"' C-m
tmux send-keys -t $NAME:0.5 'curl "localhost:11127/?op=write&val=next"' C-m
tmux send-keys -t $NAME:0.4 'curl "localhost:11127/?op=read"' C-m
